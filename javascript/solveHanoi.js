/*
 * In this challenge, you will solve the towers of Hanoi problem for five disks, 
 * by writing a recursive function solveHanoi that will solve Hanoi for any positive number of disks.
...
var hanoi = (function () {
    ...
    var moveDisk = function (fromPeg, toPeg) {
        ...
        objects.timeline.addEvent(nowFrame, duration, function () {
            ...
            if (!validmove) {
                console.log(badMoveMessage);
                return;
            }

            console.log(fromPeg.letter + " -> " + toPeg.letter);
...
var solveHanoi = function (numDisks, fromPeg, toPeg) {
    ...
    if (numDisks === 0) {
        return hanoi.isSolved(toPeg);
    }

    /* 
     * recursive case:
     */
    // Make a recursive function call to move the disks sitting on top of the bottom disk on the fromPeg to the spare peg, 
    // i.e.move(numDisks - 1) disks to the spare peg.
    ...
    // Make a recursive function call to move the disks from the spare peg back on top of the bottom disk,
    // i.e.move(numDisks - 1) disks from the spare peg to the target peg.
